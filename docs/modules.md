...
Имена модулей должны быть непустыми и уникальными внутри контейнера. Имя `root`
зарезервировано для корневого диагностического графа. Неверные имена отклоняются
